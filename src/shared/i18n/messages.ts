export const messages = {
  ...
  ru: {
    ...
    today: {
      ...
      empty: 'Записей пока нет. Нажмите "{action}", чтобы заполнить день.'
    },
    calendar: {
    ...
    appointment: {
      ...
      add: 'Добавить запись',
      notFound: 'Мы не нашли эту запись.',
      status: 'Статус: {status}',
      conflict:
        'Предупреждение о конфликте: это пересекается с другой записью. Можно сохранить, если хотите.'
    },
    form: {
    ...
    clients: {
      ...
      empty: 'Клиентов пока нет. Начните записи, чтобы собрать историю.',
    ...
    settings: {
      ...
      data: 'Данные',
      dataText: 'Экспорт или очистка локальных демо-данных.'
    },
    schedule: {
      weeklyTemplate: 'Еженедельный шаблон',
      defaultHours: 'Задайте часы по умолчанию',
      autoCreated: 'Создается автоматически при первом запуске',
      bookingDefaults: 'Настройки записи',
      defaultServiceDuration: 'Длительность услуги по умолчанию',
      bookingRules: 'Правила записи',
      bookingRulesText: 'Двойные записи блокируются с предупреждением об обходе.'
    },
    days: {
      mon: 'Пн',
      tue: 'Вт',
    ...
    login: {
      ...
      subtitle: 'Держите день в форме с быстрыми записями и чистым планом.',
      phoneOrEmail: 'Телефон или email',
      passcode: 'Код доступа',
      whyTitle: 'Почему барберы выбирают Timetrack',
      bullet1: 'Настройте недельный шаблон один раз и меняйте при необходимости.',
      bullet2: 'Записывайте клиента меньше чем за 10 секунд благодаря настройкам по умолчанию.',
